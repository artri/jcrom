 ...
 */
public class TestLazyLoading extends ModeShapeSingleUseTest {
    ...
    public void testLazyLoading() throws Exception {
        ...
        Node treeRootNode = jcrom.addNode(((Session) session).getRootNode(), tree);
    ...
    public void testDynamicMaps() throws Exception {
        ...
        Node newNode = jcrom.addNode(((Session) session).getRootNode(), dynamicObj);
        ...
        jcrom.addNode(((Session) session).getRootNode(), ref1);
        jcrom.addNode(((Session) session).getRootNode(), ref2);
